        ...
        <div className="w-full h-full relative rounded-lg">
          ...
          <div className="absolute text-white left-5 bottom-5 flex flex-col gap-7">
            ...
            <div className="flex items-center gap-x-4">
              <span className="px-4 py-3 border  rounded-lg">Action</span>
              <span className="px-4 py-3 border  rounded-lg">Adventure</span>
              <span className="px-4 py-3 border  rounded-lg">Drana</span>
            </div>
          </div>
        </div>
      </section>
