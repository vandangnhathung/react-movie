...
const MovieDetailsPage = () => {
  ...
  return (
    <>
      ...
      <div className="relative z-10 page-container grid grid-cols-3 gap-8 bottom-[350px]">
        <div className="">
          <img
          ...
          />
          <button className="uppercase p-5 bg-primary text-white rounded-lg w-full text-2xl">
            Xem phim
          </button>
        </div>
