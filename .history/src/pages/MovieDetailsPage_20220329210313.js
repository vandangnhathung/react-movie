    ...
    <>
      ...
      <div className="relative z-10 page-container grid grid-cols-3 gap-8 bottom-[325px]">
        <div className="">
          ...
          />
          <button className="uppercase p-5 bg-primary text-white rounded-lg w-full text-xl flex justify-center items-center">
            <BsFillPlayFill className="text-lg"></BsFillPlayFill>
